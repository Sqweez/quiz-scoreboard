...
<template>
  <form class="space-y-12" @submit.prevent="createGame">
    <section class="space-y-3">
      <Label for="game-title" class="text-[11px] uppercase tracking-[0.14em] text-muted-foreground">
        Название игры
      </Label>
      <input
        id="game-title"
    ...
    <section class="space-y-4">
      ...
      <ul class="divide-y divide-[var(--rule)]">
        ...
        >
          ...
          <button
            type="button"
            class="inline-flex items-center text-sm text-muted-foreground transition-colors hover:text-[var(--primary)] disabled:cursor-not-allowed disabled:opacity-40"
    ...
    <div class="flex justify-end border-t border-[var(--rule-strong)] pt-6">
